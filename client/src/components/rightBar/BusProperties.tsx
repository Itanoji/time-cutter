...
const BusProperties = ({index, signal}: SignalProps) => {
    ...
    return (
       <div className="space-y-3 justify-items-center flex flex-col">
            <button className={"text-center font-semibold border-2 border-slate-600 rounded-lg bg-slate-100 hover:bg-slate-200 active:bg-slate-300 w-20 self-center"} onClick={addArea}>Add area</button>
